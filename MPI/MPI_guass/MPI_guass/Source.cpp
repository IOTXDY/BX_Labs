...
int main(int argc, char* argv[]) {
    ...
    //LU_mpi(argc, argv);//普通快划分


    //LU_mpi_async(argc, argv);//非阻塞通信


    //LU_mpi_plus(argc, argv);//稍做优化的块划分


    //LU_mpi_circle(argc, argv);//等步长的循环划分


    //LU_mpi_withExtra(argc, argv);//尾部均分


    //LU_mpi_async_omp(argc, argv);


    //LU_mpi_async_multithread(argc, argv);//非阻塞通信+avx+omp
